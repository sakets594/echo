...
export class EnemyAI {
    ...
    update(dt, inputs) {
        ...
        if (this.state === 'chase') {
            ...
            if (distToPlayer < playerState.effectiveBreathRadius) {
            ...
            if (canDetectPlayer) {
                ...
                if (this.timers.lost > 2.0) {
                    ...
                    const searchTarget = this.lastKnownPosition ? this.lastKnownPosition.clone() : playerVec.clone();
        ...
        return {
            ...
            speed: speed,
            events: events,
            shouldMoveDirectly: (this.state === 'chase' && distToPlayer < playerState.effectiveBreathRadius && (distToPlayer < 1.0 || !breathOccluded) && distToPlayer > 0.5)
        };
    }
}
